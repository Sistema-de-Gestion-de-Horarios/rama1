...
const Horarios = (props) => {
    ...
    const [horariosName, setHorarioName] = useState("");
    const [piso, setPiso] = useState("");
    const [estado, setEstado] = useState("");
    const [showSummary, setShowSummary] = useState("");

  
    const horariosNameHandler = (event) => {
        console.log(event.target.value);
        setHorariosName(event.target.value);
    ...
    const submitHandler = (event) => {
        ...
        props.onNewAmbiente(horariosName, piso, estado);
        setHorarioName("");
        setPiso("");
        setEstado("");
    };
